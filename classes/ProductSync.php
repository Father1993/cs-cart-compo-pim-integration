...
class ProductSync
{
    ...
    private FeatureSync $feature_sync;
    ...
    * @return array
    */
    public function syncAll($catalog_uid): array
    {
        $result = [
            'synced' => 0,
            'errors' => [],
        ...
        try {
            ...
            do {
                ...
                // We receive another batch of goods
    ...
    * @return array
    */
    public function syncChanged($catalog_uid, $days = 1): array
    {
        $result = [
            'updated' => 0,
            'errors' => [],
    ...
    * @return array
    */
    private function processBatch($products): array
    {
        $result = [
            'synced' => 0,
            'errors' => [],
    ...
    * @return bool
    */
    private function syncProduct($pim_product): bool
    {
        try {
            ...
            // We process the manufacturer as a characteristic
    ...
    * @return array
    */
    private function mapPimToCSCart($pim_product, $category_id): array
    {
    ...
    * @param array $pim_product
    */
    private function syncProductImages($product_id, $pim_product): void
    {
        try {
            $images_to_sync = [];
            // Main image
    ...
    * @param int $position
    */
    private function syncImage($product_id, $image_name, $type, $position = 0): void
    {
        try {
            // Generate a path for saving
            ...
            // Save in CS-CART
            // Copy the file to a temporary directory with the correct name
    ...
    * @param array $params
    */
    private function syncProductFeatures($product_id, $params): bool
    {
    ...
    * @param array $pim_product
    */
    private function syncManufacturer($product_id, $pim_product): void
    {
        try {
